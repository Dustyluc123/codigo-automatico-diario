...
- [x] Implementar o conteúdo do rodapé (footer) na página inicial (index.html), incluindo informações de direitos autorais, links de navegação adicionais (ex: Sobre Nós, Política de Privacidade, Termos de Serviço), links para redes sociais e, opcionalmente, um campo para inscrição em newsletter. Use semântica HTML apropriada para a estrutura.
      ...
      <footer class="main-footer">
          <div class="footer-container container">
              <div class="footer-section footer-info">
                  ...
                  <p>Seu destino para as melhores compras online!</p>
              </div>
              ...
              <div class="footer-section footer-social">
                  ...
                  <div class="social-links">
                      <a href="https://facebook.com/ecommerce" target="_blank" rel="noopener noreferrer" aria-label="Visite nossa página no Facebook">Facebook</a>
                      <a href="https://twitter.com/ecommerce" target="_blank" rel="noopener noreferrer" aria-label="Siga-nos no Twitter">Twitter</a>
                      <a href="https://instagram.com/ecommerce" target="_blank" rel="noopener noreferrer" aria-label="Veja nosso perfil no Instagram">Instagram</a>
                      <a href="https://linkedin.com/company/ecommerce" target="_blank" rel="noopener noreferrer" aria-label="Conecte-se conosco no LinkedIn">LinkedIn</a>
                  </div>
              </div>

              <div class="footer-section footer-newsletter">
                  <h3>Receba Nossas Novidades</h3>
                  <p>Assine nossa newsletter para receber as últimas ofertas e atualizações.</p>
                  <form class="newsletter-form">
                      <label for="newsletter-email" class="sr-only">Seu e-mail</label>
                      <input type="email" id="newsletter-email" placeholder="Seu e-mail" aria-label="Seu endereço de e-mail" required>
